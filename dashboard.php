...
<body>
    ...
    <form action="dashboardpt2.php?id='<?php echo $row['id']; ?>'" method="post"> 
            ...
            <div class="info-main">
                <div class="info-left">
                    <div class="info-input-field">
                        ...
                        <div class="php-info"><?php echo $row['name']; ?></div>
                    </div>

                    <div class="age-birth">
                        <div class="info-input-field small">
                            <label for="info-age">AGE</label>
                            <div class="php-info"><?php echo $row['age']; ?></div>
                        </div>

                        <div class="info-input-field medium">
                            <label for="info-birthday">BIRTHDATE</label>
                            <div class="php-info"><?php echo $row['birthdate']; ?></div>
                        </div>
                    </div>

                    <div class="info-input-field">
                        <label for="info-address">ADDRESS</label>
                        <div class="php-info"><?php echo $row['address']; ?></div>
                    </div>

                    <div class="info-input-field">
                        <label for="info-contact-number">CONTACT NUMBER</label>
                        <div class="php-info"><?php echo $row['number']; ?></div>
                    </div>

                    <div class="info-input-field">
                        <label for="info-username">USERNAME</label>
                        <div class="php-info"><?php echo $row['username']; ?></div>
                    </div>

                    <div class="info-input-field">
                        <label for="info-username">PASSWORD</label>
                        <div class="php-info"><?php echo $row['password']; ?></div>
                    </div>
                ...
                <div class="info-right">
                    ...
                    <div class="info-input-field">
                        ...
                        <div class="php-info"><?php echo $row['email']; ?></div>
                    </div>

                    <div class="info-input-field">
                        <label for="info-membership-plan">MEMBERSHIP PLAN</label>
                        <div class="php-info"><?php echo $row['membership']; ?></div>
                    </div>

                    <div class="info-input-field">
                        <label for="info-payment-mode">MODE OF PAYMENT</label>
                        <div class="php-info"><?php echo $row['mode_of_payment']; ?></div>
                    </div>
                   
                    <form action="dashboard.php?id='<?php echo $row['id']; ?>'" method="post">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>" > 
                    <button onclick="location.href = 'dashboardpt2.php?id='<?php echo $row['id']; ?>'" name="edit" type="submit" class="edit-info btn-border-pop">EDIT</button>
                    </form>
                </div>
            </div>
        </div>
